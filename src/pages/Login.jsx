...
import { ArrowLeft, Mail, AlertTriangle, Lock } from "lucide-react";
...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      addToast("success", "Authentication successful. Access granted.");
      ...
      <ContentArea>
        <FormCard>
          ...
          <BottomLinks>
            ...
            <StyledLink to="/signup">No access? Join Now</StyledLink>
          </BottomLinks>
        </FormCard>
      </ContentArea>
      <Footer />
